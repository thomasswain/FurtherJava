...
public class QueueTest {
	...
	public void run() {
		...
		//p.join() : wait for this thread to die.
		q.put("EOF");
		//terminate join at 10 seconds since EOF marker may get lost
		for (Consumer c : consumers) try {c.join(10000);} catch (InterruptedException e) {}
		//c.join(10000) : wait at most 10000 milliseconds for this thread to die.
		int recv = 0;
